...
function App() {
        ...
        <div className="drawer">
            ...
            <div className="drawer-content flex flex-col">
              ...
              <div className="navbar bg-base-300 w-full">
                ...
                <div className="mx-2 flex-1 px-2 font-extrabold text-primary">Welcome</div>
                ...
                <li>
                  <a href='https://github.com/Overhaul66' >
                    <img
                      ...
                      alt="App Logo"
                      className="w-5"
                    /> <p className='text-primary font-bold'>my github</p>
                  </a>
              ...
              {/* hero */}
                  ...
                  <div className="hero-content flex-col lg:flex-row lg:gap-20">
                    ...
                    <div>
                      ...
                      <p className="py-2 text-lg text-neutral">
                        A <span className="font-bold text-primary">backend developer</span> focused on building robust and scalable systems.<br />
                        Currently expanding my skills into the <span className="font-bold text-secondary">frontend</span> world to become a more versatile developer.
                      </p>
                      <button className="btn btn-outline btn-primary mt-4">Donwload CV</button>
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg text-neutral leading-relaxed">
                  I’m a <span className="font-semibold text-secondary">Fullstack Developer</span> passionate about creating
                  efficient, scalable, and user-friendly web solutions. With experience in both
                  <span className="font-bold text-primary"> frontend</span> and
                  <span className="font-bold text-primary"> backend</span> development, I build seamless applications that deliver real value.
                </p>
          ...
          {/* Skills */}
          <div>
            <h1 className='text-center font-extrabold text-4xl text-primary mt-6 mb-5 '>My Skills</h1>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 bg-base-100 p-6  max-w-7xl mx-auto">
  ...
  <h1 className='text-center font-extrabold text-4xl text-primary mt-6 mb-5'>Projects</h1>
  ...
  <div className="w-full flex justify-center">
    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6 max-w-screen-xl w-full'>
      ...
      {/* contact me */}
      <form className="max-w-xl mx-auto bg-base-100 p-6 rounded-xl shadow-lg space-y-4 mt-10  " action="https://formsubmit.co/willadan667@gmail.com" method="POST">
...
<div className="drawer-side">
  ...
  <aside className="menu bg-base-200 min-h-full w-80 py-10 px-4 rounded-r-2xl shadow-lg flex flex-col">
    ...
    <div className="flex flex-col items-center mb-8">
      ...
      <span className="font-bold text-lg text-primary">My Github</span>
    </div>
    {/* Navigation menu */}
    <ul className="flex-1 space-y-2">
      <li>
        <a className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary hover:text-primary-content transition-colors">
          ...
          <span className='font-bold text-neutral'>Projects</span>
        </a>
      </li>
      <li>
        <a className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary hover:text-primary-content transition-colors">
          ...
          <span className='font-bold text-neutral'>About me</span>
        </a>
      </li>
      {/* Add more menu items as needed */}
       <li>
        <a className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primary hover:text-primary-content transition-colors">
          ...
          <span className='font-bold text-neutral'>Email</span>
        </a>
      </li>
    </ul>
